...
/**
 * On activation: flush rewrites and create three sample rooms once.
 */
function azure_activate() {
	...
	if ( ! get_option( 'azure_rooms_seeded' ) ) {
		$samples = array(
			array( __( 'Lagoon Garden Room', 'azure-isle' ), '$240', '42 m²', __( '2 Guests', 'azure-isle' ), __( 'King Bed', 'azure-isle' ), __( 'Garden View', 'azure-isle' ), __( 'A calm ground-floor room opening onto a private garden terrace, a few steps from the lagoon.', 'azure-isle' ) ),
			array( __( 'Ocean View Suite', 'azure-isle' ), '$380', '65 m²', __( '3 Guests', 'azure-isle' ), __( 'King Bed', 'azure-isle' ), __( 'Ocean View', 'azure-isle' ), __( 'A light-filled suite with a separate lounge and a wide balcony facing the open sea.', 'azure-isle' ) ),
			array( __( 'Overwater Pool Villa', 'azure-isle' ), '$620', '110 m²', __( '4 Guests', 'azure-isle' ), __( '2 Beds', 'azure-isle' ), __( 'Lagoon View', 'azure-isle' ), __( 'Built on stilts above the lagoon, with a private plunge pool and steps straight into the water.', 'azure-isle' ) ),
		);
